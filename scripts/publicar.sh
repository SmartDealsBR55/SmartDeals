...
rm -f SmartDeals-atualizacao.zip SmartDeals-painel-celular.zip SmartDeals-correcao-importacao.zip SmartDeals-categorias-compactas.zip SmartDeals-sem-rolagem-lateral.zip
git add -A
